      ...
      <div className="mx-auto max-w-xl-7 px-6 lg:px-8">
        ...
        <div className="mt-32 flex w-full flex-col gap-32">
          {portfolios.map((portfolio) => (
            <div
              key={portfolio.id}
              className="group rounded-xl bg-background-layer-2 pb-20 sm:pb-24 xl:pb-0">
                ...
                <div className="-mt-8 w-full max-w-xl-2 group-even:order-none xl:-mb-8 xl:w-96 xl:flex-none group-even:xl:order-1">
                  <div className="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
                    <Image
                      ...
                      alt={portfolio.title}
                      fill
                      className="!absolute !inset-0 !h-full !w-full rounded-xl bg-slate-800 object-cover shadow-xl-2"
                    />
                  </div>
                </div>
                <div className="w-full max-w-xl-2 xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                  <figure className="relative isolate pt-6 sm:pt-12">
                    <svg className="absolute left-0 top-0 -z-10 h-32 fill-none stroke-slate-800">
                      <path
                    ...
                    <h3 className="text-xl-2 font-semi-bold tracking-tight text-white sm:text-xl-3">
                      {portfolio.title}
                    </h3>
                    <blockquote className="mt-4 text-xl font-medium leading-8 text-slate-400 sm:text-xl-2 sm:leading-9">
