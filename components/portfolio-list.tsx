  ...
  return (
    <div className="my-32 mb-0 flex w-full flex-col gap-20 xl:mb-32 xl:gap-24">
      {portfolios.map((portfolio) => (
        <div
          key={portfolio.id}
          className="group relative z-40 bg-slate-900 pb-20 sm:pb-24 xl:rounded-xl xl:pb-0">
            ...
            <div className="-mt-8 w-full max-w-xl-2 group-even:order-none xl:-mb-8 xl:w-96 xl:flex-none group-even:xl:order-1">
              <div className="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
                <Image
                  ...
                  alt={portfolio.title}
                  fill
                  className="!absolute !inset-0 !h-full !w-full rounded-xl bg-border object-cover shadow-xl-2"
                />
              </div>
            </div>
